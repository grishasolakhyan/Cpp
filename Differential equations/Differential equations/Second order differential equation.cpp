...
void differ(double x[], double y[], double xn, double y1, double yn, int p, int q, double h, int n);
int main()
{
	SetConsoleCP(1251);
	SetConsoleOutputCP(1251);
	
	double x1 = -4; double xn = -1;
	double y1 = -10; double yn = -58;
	
	int p = -6; int q = 1;

	int n = 20; double h = (xn - x1) / n;
